...
<div class="main">
  <header>
    ...
    <input type="hidden"  class="input"  name="viewType" value=""/>
                   <ul id="menu">
		   <li><a href="#" onClick="performAction('managecourses');"><span><span>Manage Tickets</span></span></a></li>
		  <li id="menu_active"><a href="#" onClick="performAction('services');"><span><span>Raise Tickets</span></span></a></li>
